...
var RightMenuUserProfile = React.createClass({
    ...
    render: function() {
        ...
        return (
            <span className="miit-component user-profile">
                ...
                <span className="user-profile-status"><i className="fa fa-circle stat-open mr5"></i> {this.props.text.connected}</span>
            </span>
        );
    }
});

module.exports = RightMenuUserProfile;